# WixToolset.Extensibility - extensibility interfaces for the WiX Toolset

The `WixToolset.Extensibility` package provides the interfaces and base classes WiX Extensions implement to extend the WiX Toolset.
